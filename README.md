...
<p> Для начала мы начали исследование области определения с того, как рассчитывается индекс счастья. Мы воспользовались <a href='https://www.marketing-mba.ru/article/v3_14/Pashkus_V.pdf'> данным источником ("КАЧЕСТВО ЖИЗНИ: ПОНЯТИЕ, ПОДХОДЫ И ОЦЕНКА" Пашкус В.Ю., Красникова Т. С.</a></p>
...
<p>Другое исследование по вычислению индекса счастья есть в <a href = 'https://www.prosperity.com/rankings>исследовании Legatum Institute</a> и <a href = 'https://docs.prosperity.com/2916/0568/0539/The_Legatum_Prosperity_Index_2020.pdf'>The Legatum Prosperity Index. A tool for transformation (2020)</a></p>
  <p> Здесь можно кратко все объяснить, лишь одной картинкой \smiley{}.</p>
  <p align = 'center'><img src = 'index_happy_pic.png' width="50%">Выделенные признаки в исследовании Legatum Institute</p>
...
<ul>
  <li><a href = 'https://d1wqtxts1xzle7.cloudfront.net/61690878/A309610911920200106-123272-1jhjtv6.pdf?1578300604=&response-content-disposition=inline%3B+filename%3DHappy_Index_and_Social_Well_Being_of_Rus.pdf&Expires=1615631365&Signature=MbtJPjTDZS8DFHfIWZ5a6xULjJwxtMFWmWodBhk~nGIB-PHsBdVXknCiwarbgg88jYAqSh~R2vpHlhznqHBOCwmBEJkYcPuonajWZ6C2TpIw4EXD6N3098B1UppEZw87dGk7L4iaZzZ2xDjL0oEgLfVLdpd7evlCSeRc68Wv6c0b~eK2kHi5ZseuWFceXkK-C28oaQmQ65ce7cimwqarkqFrHCCJXmXEOcL~Fblbg08wCuQnbgsazEAU17wDOlsXVLs0UNA~JwHIWnF5gXhWVYnV6hx1INVLwcLxGm6237mTEA4iXdaNS5JpI2hiiXTS~lVYABX4GsAXG9Y~aD5bag__&Key-Pair-Id=APKAJLOHF5GGSLRBV4ZA>Индекс счастья студентов</a></li>
...
<h2>Описание прототипа системых</h2>
...
<img src = 'https://raw.githubusercontent.com/Alena0704/index_happy_pentagon/idea-project/архитектура%20модели.png'>
...
<h2>Выводы</h2>
<p> В ходе реализации проекта мы проши долгий и тернеситый путь в изучении модулей и приобретении опыта в реализации проекта. Очень благодарны за обучение и менторство А.Г.Кравец. Ее мудрость и опыт помогли нам грамотно составить проектную архитектуру, вывести идею проекта и довести его до конечной точки.</p>
